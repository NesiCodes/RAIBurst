...
public class CameraActivity extends AppCompatActivity implements SurfaceHolder.Callback, AREventListener {
    ...
    private void initializeFilters() {
        ...
        effects.add("cute-virtual-pet.deepar");
        effects.add("lightbulb.deepar");
        effects.add("bright-glasses.deepar");
    ...
    private void initalizeViews() {
        ...
        openActivity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(CameraActivity.this, BasicActivity.class);
    ...
    private void initializeDeepAR() {
        ...
        deepAR.setLicenseKey("26ac81ab98a8462c5c042e5032ba5566ab2898ec43d3883ec1ca5e1ff37e3397d9d5e3c19aff69f8");
